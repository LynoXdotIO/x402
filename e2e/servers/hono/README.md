# @lynoxdotio/x402-hono Example Server

This is an example Hono server that demonstrates how to use the `@lynoxdotio/x402-hono` middleware to implement paywall functionality in your API endpoints.
