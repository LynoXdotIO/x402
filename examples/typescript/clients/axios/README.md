...
2. Copy `.env-local` to `.env` and add your Ethereum private key (remember it should have USDC on Arc Testnet, which you can provision using the [Circle Faucet](https://faucet.circle.com)):
